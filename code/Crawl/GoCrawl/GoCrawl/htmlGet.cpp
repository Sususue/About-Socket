...
/*发送POST请求*/
bool sendRequestPOST(SOCKET sock, const string& host, const string& resource, const string& schoolname, const int page, const string schoolId) {

	char sPage[3], sLen[10];
	...
	string http = "POST " + resource + " HTTP/1.1\r\n"//注意这个地方GET后和HTTP前都有空格
		...
		+ "referer: https://www.icourse163.org/university/"+schoolname+"\r\n"
		+ "Connection: close\r\n\r\n"
		+ sendData + "\r\n\r\n";//发送的内容，为from data的内容
		//发送内容中的p=1，代表页数
